...
var wasmBinaryFile;
  wasmBinaryFile = 'EmscriptenGLFW.wasm';
...
var ASM_CONSTS = {
  ...
  var GLFW = {WindowFromId:function(id) {
        ...
        (function(a1, a2, a3) { throw 'Internal Error! Attempted to invoke wasm function pointer with signature "vidd", but no such functions have gotten exported!'; })(GLFW.active.id, Browser.mouseX, Browser.mouseY);
        ...
        (function(a1, a2, a3) { throw 'Internal Error! Attempted to invoke wasm function pointer with signature "vidd", but no such functions have gotten exported!'; })(GLFW.active.id, sx, sy);
...
unexportedRuntimeSymbol('MAX_INT53', false);
unexportedRuntimeSymbol('MIN_INT53', false);
unexportedRuntimeSymbol('bigintToI53Checked', false);
...
unexportedRuntimeSymbol('emscriptenWebGLGetBufferBinding', false);
unexportedRuntimeSymbol('emscriptenWebGLValidateMapBufferTarget', false);
...
var emscriptenWebGLGetBufferBinding = missingLibraryFunc('emscriptenWebGLGetBufferBinding');
var emscriptenWebGLValidateMapBufferTarget = missingLibraryFunc('emscriptenWebGLValidateMapBufferTarget');
