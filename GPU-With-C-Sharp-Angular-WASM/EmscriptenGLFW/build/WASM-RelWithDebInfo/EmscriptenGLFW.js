...
var ASM_CONSTS = {
  ...
  var GLFW = {WindowFromId:function(id) {
        ...
        (function(a1, a2, a3) { /* a dynamic function call to signature vidd, but there are no exported function pointers with that signature, so this path should never be taken. Build with ASSERTIONS enabled to validate. */ })(GLFW.active.id, Browser.mouseX, Browser.mouseY);
        ...
        (function(a1, a2, a3) { /* a dynamic function call to signature vidd, but there are no exported function pointers with that signature, so this path should never be taken. Build with ASSERTIONS enabled to validate. */ })(GLFW.active.id, sx, sy);
